...
1. Clone this repo!
   ...
   (this will already be done for you if you use _GitHub Codespaces!_)
...
7. Generate Rails credentials.
   ...
   The problem with this is that we have _no_ visual editors in the Docker container. As such, you'll have to install one.
