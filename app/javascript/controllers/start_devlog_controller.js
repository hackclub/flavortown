...
export default class extends Controller {
  ...
  connect() {
    if (this.hasBodyTarget) {
      this.bodyTarget.value = "I'm working on my first project! This is so exciting. I can't wait to share more updates as I build."
    }
  ...
  async prefillImage() {
    const fileInput = this.element.querySelector('input[type="file"][name*="devlog_attachment"]')
    if (!fileInput) return
