...
(!(function () {
  ...
  e.prototype = {
    ...
    volume: function (e) {
      var t = this || n;
      if (
        ((e = parseFloat(e)), t.ctx || s(), void 0 !== e && e >= 0 && e <= 1)
      ) {
  ...
  t.prototype = {
      ...
      if (!(s >= p)) {
        ...
        if (o._webAudio) {
          ...
          "running" === n.state && "interrupted" !== n.ctx.state
            ? v()
            : ((o._playLock = !0), o.once("resume", v), o._clearTimer(u._id));
        } else {
          var h = function () {
            ((m.currentTime = s),
              (m.muted = u._muted || o._muted || n._muted || m.muted),
              (m.volume = u._volume * n.volume()),
            ...
            try {
              ...
              if (
                ...
                (r instanceof Promise || "function" == typeof r.then)
                  ...
                  : t || ((o._playLock = !1), f(), o._emit("play", u._id)),
                (m.playbackRate = u._rate),
                m.paused)
              )
                return void o._emit(
              ...
              "__default" !== e || u._loop
                ...
                : ((o._endTimers[u._id] = function () {
                    (o._ended(u),
                      m.removeEventListener("ended", o._endTimers[u._id], !1));
                  }),
          ...
          if (m.readyState >= 3 || A) h();
            ...
            var y = function () {
              ((o._state = "loaded"),
                h(),
                m.removeEventListener(n._canPlayEvent, y, !1));
            };
            (m.addEventListener(n._canPlayEvent, y, !1), o._clearTimer(u._id));
          }
        }
        return u._id;
      }
        ...
        if (d) {
          if ((r || a._stopFade(i[u]), a._webAudio && !d._muted)) {
            ...
            ((d._volume = e),
              ...
              d._node.gain.linearRampToValueAtTime(t, _));
          }
            ...
            d =
              (1e3 *
                ((r._sprite[o._sprite][0] + r._sprite[o._sprite][1]) / 1e3 -
                  u)) /
              Math.abs(o._rate);
          ((!r._endTimers[t[i]] && o._paused) ||
            (r._clearTimer(t[i]),
            (r._endTimers[t[i]] = setTimeout(r._ended.bind(r, o), d))),
            r._emit("rate", o._id));
        }
      return r;
    },
    ...
    unload: function () {
      ...
      for (o = 0; o < n._howls.length; o++)
        if (
          n._howls[o]._src === e._src ||
          e._src.indexOf(n._howls[o]._src) >= 0
        ) {
          i = !1;
          break;
        }
            ...
            d = {
              ...
              coneOuterAngle:
                void 0 !== e.coneOuterAngle
                  ...
                  : d.coneOuterAngle,
              coneOuterGain:
                void 0 !== e.coneOuterGain ? e.coneOuterGain : d.coneOuterGain,
              distanceModel:
                void 0 !== e.distanceModel ? e.distanceModel : d.distanceModel,
              maxDistance:
                void 0 !== e.maxDistance ? e.maxDistance : d.maxDistance,
              refDistance:
                void 0 !== e.refDistance ? e.refDistance : d.refDistance,
              rolloffFactor:
                void 0 !== e.rolloffFactor ? e.rolloffFactor : d.rolloffFactor,
              panningModel:
                void 0 !== e.panningModel ? e.panningModel : d.panningModel,
            };
            var s = o._panner;
            (s ||
