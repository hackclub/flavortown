...
ActiveRecord::Schema[8.1].define(version: 2025_12_26_190638) do
  ...
  create_table "ship_certifications", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.jsonb "ysws_feedback_reasons", default: []
  ...
  create_table "ysws_review_devlog_approvals", force: :cascade do |t|
    ...
    t.bigint "reviewer_id"
    t.datetime "updated_at", null: false
    t.bigint "ysws_review_submission_id", null: false
    t.index ["post_devlog_id"], name: "index_ysws_review_devlog_approvals_on_post_devlog_id"
    t.index ["reviewer_id"], name: "index_ysws_review_devlog_approvals_on_reviewer_id"
    t.index ["ysws_review_submission_id", "post_devlog_id"], name: "idx_ysws_devlog_approvals_unique", unique: true
    t.index ["ysws_review_submission_id"], name: "idx_on_ysws_review_submission_id_8b0db5beb0"
  end
  ...
  add_foreign_key "ysws_review_devlog_approvals", "ysws_review_submissions"
end
