...
# docker build -t battlemage-worker .
# docker run -d -e RAILS_MASTER_KEY=<value from config/master.key> --name battlemage-worker battlemage-worker
...
# Final stage for app image (worker)
FROM base
...
# Worker-only container: start Solid Queue
